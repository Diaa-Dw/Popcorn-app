...
import { Rating } from "./RatingStars.style";
...
function RatingStars({
  ...
  function handleRating(rating: number) {
    setRating((s) => (s === rating ? null : rating));
    onSetRating((s) => (s === rating ? null : rating));
  }
    ...
    <Rating>
      {Array.from({ length: maxRating }, (_, i) => (
        <Star
          ...
          full={tempRating ? tempRating >= i + 1 : (rating as number) > i}
